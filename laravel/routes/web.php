...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/product', [MerchantController::class, 'setting'])->name("merchant-product");
    ...
    Route::get('/addlove/{product_id}', [FavoriteController::class, 'store']);
    Route::get('/removelove/{fav_id}', [FavoriteController::class, 'destroy']);
});
